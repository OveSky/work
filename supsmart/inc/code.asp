...
Const nNoisyLineCount =3										' 噪音线条数
Const nCharMin = 5											' 产生的最小字符个数
Const nCharMax = 5											' 产生的最大字符个数
Const nSpaceX = 2											' 左右两边的空白宽度
Const nSpaceY = 2											' 上下两边的空白宽度
IF Isnumeric(Request("t0")) And Request("t0")<>"" Then nImgWidth =Request("t0")	Else nImgWidth=64	' 数据区宽度
IF Isnumeric(Request("t1")) And Request("t1")<>"" Then nImgHeight=Request("t1")	Else nImgHeight=18	' 数据区高度				
