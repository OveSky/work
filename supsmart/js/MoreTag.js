...
function getSelectedTags(){
	var arr = new Array();
	var arrid = new Array();
	$('#myTags a').each(function(index){
		arr.push($(this).attr('title'));
		arrid.push($(this).attr('value'));		
	});
	
		document.getElementById("ActTag").value=arr.toString();
		document.getElementById("ActTagid").value=arrid.toString();
