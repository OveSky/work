<html><head>
	...
	<body>
		...
		<!--js选择菜单END部分-->
		<input type="hidden" id="lesson" name="lesson" value="0">
		<input type="hidden" id="lessonX" name="lesson" value="0">
		<script src="../js/mui.picker.min.js"></script>
		<script src="../js/mui.picker.js"></script>
		<script src="../js/mui.poppicker.js"></script>
		<script src="../js/ss.XZ.js"></script>
